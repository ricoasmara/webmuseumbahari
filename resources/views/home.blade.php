...
<section class="jumbotron">
    <img src="img/museumbahari.jpg" class="rounded mx-auto d-block" alt="museumbahari" width="500">
  <h1 class="display-4">Sejarah Museum</h1>
  <p class="lead">Museum Bahari adalah museum yang menyimpan koleksi yang berhubungan dengan kebaharian dan kenelayanan bangsa Indonesia dari Sabang hingga Merauke. Museum ini berada di bawah pengawasan dari Dinas Kebudayaan Permuseuman Provinsi Daerah Khusus Ibukota Jakarta.
